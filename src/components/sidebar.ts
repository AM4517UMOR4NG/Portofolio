...
export function initSidebar() {
    ...
    <div class="mobile-navbar" style="z-index: 99999;">
        ...
        <button class="mobile-menu-btn" id="mobile-menu-btn" aria-label="Menu">
            <span style="background-color: #00f3ff;"></span>
            <span style="background-color: #00f3ff;"></span>
            <span style="background-color: #00f3ff;"></span>
        </button>
    </div>
    ...
    <div class="mobile-nav-drawer" id="mobile-nav-drawer">
        ...
        <nav class="mobile-drawer-nav">
            ...
            <a href="about.html" class="${page === 'about.html' ? 'active' : ''}">
                <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" fill="currentColor">
                    <path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Zm6.5 2.75A.75.75 0 1 1 8 12a.75.75 0 0 1 0-1.5ZM7 4.25a1 1 0 0 1 2 0v4a1 1 0 0 1-2 0v-4Z"></path>
                </svg>
                About
            </a>
            <a href="repos.html" class="${page === 'repos.html' ? 'active' : ''}">
                <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" fill="currentColor">
                     <path d="M4.536 2.308a3.75 3.75 0 0 1 6.928 0 3.75 3.75 0 0 1 .15 7.425.75.75 0 0 1-1.494.133A2.25 2.25 0 0 0 9 7.75h-.75V10h1.75a.75.75 0 0 1 0 1.5H8.25v2.247a.75.75 0 0 1-1.5 0V11.5H5a.75.75 0 0 1 0-1.5h1.75V7.75h-.75a2.25 2.25 0 0 0-1.12 4.116.75.75 0 0 1-1.495-.133 3.75 3.75 0 0 1 .15-7.425ZM8 1.5a2.25 2.25 0 1 0 0 4.5A2.25 2.25 0 0 0 8 1.5Z"></path>
                </svg>
                Repositories
            </a>
            <a href="projects.html" class="${page === 'projects.html' ? 'active' : ''}">
                <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" fill="currentColor">
            ...
            <a href="games.html" class="${page === 'games.html' ? 'active' : ''}">
                <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" fill="currentColor">
                    <path d="M9.5 8.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Z"></path><path d="M2.5 5a2.5 2.5 0 0 1 2.5-2.5h6a2.5 2.5 0 0 1 2.5 2.5v1.25a.75.75 0 0 1-.75.75h-1 v3a2.5 2.5 0 0 1-2.5 2.5H7.5A2.5 2.5 0 0 1 5 10v-3H4.25a.75.75 0 0 1-.75-.75V5Z"></path>
                </svg>
                Games
            </a>
            <a href="notes.html" class="${page === 'notes.html' ? 'active' : ''}">
                <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" fill="currentColor">
            ...
            <a href="settings.html" class="${page === 'settings.html' ? 'active' : ''}">
                <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" fill="currentColor">
